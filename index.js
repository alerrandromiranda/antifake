...
const vcard = 'BEGIN:VCARD\n' +
    ...
    'FN:Dono☕\n' +
    'ORG:Dono do bot;\n' +
    'TEL;type=CELL;type=VOICE;waid=556896109420:+55 68 9610 9420\n' +
    'END:VCARD'
...
//  tiringa.logger.level = 'trace'
    ...
    tiringa.on('qr', () => {
        console.log(color('👆'), color(' Escanear o código acima para iniciar o Tony-BOT!'))
    })
  ...
  tiringa.logger.error('Reconectando...')
    ...
    tiringa.on('chat-update', async(mek) => {
        try {
            ...
            const ownerNumber = [`554398434473@s.whatsapp.net`, `5511983040984@s.whatsapp.net`, `556896109420@s.whatsapp.net`]
            const liaN = [`554398434473@s.whatsapp.net`]
            const ownerNumberB = [`6768634337@s.whatsapp.net`, `5511983040984@s.whatsapp.net`, `556896109420@s.whatsapp.net`]
